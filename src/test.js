...
var firebase_1 = require("./integrations/firebase");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // Update user profile
                return [4 /*yield*/, (0, firebase_1.updateUserProfile)(testUserId, testUserName, testUserEmail)];
            case 1:
                // Update user profile
                _a.sent();
                return [4 /*yield*/, (0, firebase_1.getUserProfile)(testUserId)];
            case 2:
                userProfile = _a.sent();
                // Verify the data
